        ...
        <div className="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
            {!showScanner ? (
              <>
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto inline-flex items-center gap-2 px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600"
                  >
                    Add Product
                  </button>
                </form>
            ...
            <button
              ...
              className={`w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-600 ${
